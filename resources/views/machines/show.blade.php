    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
            ...
            <span class="sm:ml-3 shadow-sm rounded-md">
                ...
                <a href="{{ route( 'services.create', $machine->id ) }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:shadow-outline-indigo focus:border-indigo-700 active:bg-indigo-700 transition duration-150 ease-in-out">
                    <svg class="-ml-1 mr-2 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                    Create Service
        ...
        <div>
            <dl>
                ...
                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                    {{ $machine->user ? $machine->user->name . ' (' . $machine->user->email . ')': 'Sin Usuario'}}
                    </dd>
                </div>
