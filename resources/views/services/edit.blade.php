                            ...
                            <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <select id="machine" name="machine_id" value="{{ old('machine_id') }}"
                                                ...
                                                @foreach($machines as $machine)
                                                    ...
                                                    <option value="{{ $machine->id }}" 
                                                        @if($machine->id == $service->machine->id) selected @elseif( old('machine_id') == $machine->id ) selected @endif
                                ...
                                <div class="col-span-2 sm:col-span-2">
                                    ...
                                    <input id="date" name="date" type="date" 
                                        value="@error('date'){{ old('date') }}@enderror{{$service->date}}"
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <input id="failure" name="failure" type="text" 
                                        value="@error('failure'){{ old('failure') }}@enderror{{$service->failure}}"
                                        class="form-input rounded-md shadow-sm mt-1 block w-full">
                                ...
                                <div class="col-span-2 sm:col-span-2">
                                    ...
                                    <input id="price" name="price" type="number"
                                        value="@error('price'){{ old('price') }}@enderror{{$service->price}}"
                                        class="form-input rounded-md shadow-sm mt-1 block w-full">
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <textarea id="failure_description" name="failure_description"
                                        class="form-input rounded-md shadow-sm mt-1 block w-full">@error('failure_description'){{ old('failure_description') }}@enderror{{$service->failure_description}}</textarea>
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <textarea id="service_description" name="service_description"
                                        class="form-input rounded-md shadow-sm mt-1 block w-full">@error('service_description'){{ old('service_description') }}@enderror{{$service->service_description}}</textarea>
