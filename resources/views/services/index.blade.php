        ...
        <div class="mt-5 flex lg:mt-0 lg:ml-4">
            ...
            <div class="relative text-gray-600">
                ...
                <form action="{{ route('services.index') }}" method="GET">
                    ...
                    <input type="search" name="search" placeholder="Failure, Owner, Model" class="bg-white h-10 px-5 pr-10 rounded-full text-md focus:outline-none">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                    <a href="{{ route('services.show', $service->id ) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
